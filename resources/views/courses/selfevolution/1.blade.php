...
<main>
    ...
    <div class="container-fluid">
        <div class="container p-4">
            <iframe  src="https://www.youtube.com/embed/sA0yMW0G370" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <button class="btn btn-rounded primary float-start disabled bg-primary">Prev</button>
            <a href="{{ route('courses.selfevolution2')}}"><button class="btn bg-primary btn-rounded float-end">Next</button></a>
