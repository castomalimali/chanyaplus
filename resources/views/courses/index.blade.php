  ...
  <div>
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                  <a href="{{ route('courses.time')}}">
                    <img src="{{   asset('assets/img/illustration/time.png') }}" class="card-img-top" alt="Image 1">
                    <div class="card-body">
              ...
              <div class="col-md-4">
                <div class="card mb-4">
                  <a href="{{ route('courses.seven-levels')}}">
    ...
    {{-- <hr class="my-4 w-50 ms-auto me-auto"> --}}
    <div style="background: rgba(0, 119, 231, 0.205)">
        <div class="container my-4">
          <div class="row">
              <h3 class="py-3">Inpirarion</h3>
              <div class="col-md-4">
                  <div class="card mb-4">
                    <a href="{{ route('courses.learnfromher1')}}">
                      <img src="{{ asset('assets/img/illustration/storry.png') }}" class="card-img-top" alt="Image 1">
                      <div class="card-body">
